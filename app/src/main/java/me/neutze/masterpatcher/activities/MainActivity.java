...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Application> applicationsList = Application.getApplications(getApplicationContext());
        ApplicationsAdapter adapter = new ApplicationsAdapter(applicationsList, getApplicationContext());
